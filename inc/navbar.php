...
<!-- /Preloader -->
  ...
  <div class="fixed-sidebar-left">
    <ul class="nav navbar-nav side-nav nicescroll-bar">
      ...
      <li>
        <a href="index.php?token=<?php echo Config::get('csrf_token'); ?>"><div class="pull-left"><i class="zmdi zmdi-landscape mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
      </li>
      <li>
        <a href="import_security.php?token=<?php echo Config::get('csrf_token'); ?>" data-target="#app_dr"><div class="pull-left"><i class="zmdi zmdi-apps mr-20"></i><span class="right-nav-text">Cameras</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
      </li>
      <li>
        <a href="import_petra.php?token=<?php echo Config::get('csrf_token'); ?>"><div class="pull-left"><i class="zmdi zmdi-flag mr-20"></i><span class="right-nav-text">Petra</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
      </li>
      <li>
        <a href="batch.php?token=<?php echo Config::get('csrf_token'); ?>"><div class="pull-left"><i class="zmdi zmdi-smartphone-setup mr-20"></i><span class="right-nav-text">Batch</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
      </li>
    </ul>
  </div>
  <!-- /Left Sidebar Menu -->
